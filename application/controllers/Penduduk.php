...
class Penduduk extends CI_Controller {
	...
	public function tampil() {
		$data['title'] = "Data Penduduk - NAGARI KOTO NAN DUOu";
	...
	public function tampil_penduduk() {
		$data['title'] = "Data Penduduk - NAGARI KOTO NAN DUO";
		$data['penduduk'] = $this->m_penduduk->tampil();
	...
	public function tambah() {
		$data['title'] = "Tambah Penduduk - NAGARI KOTO NAN DUO";
	...
	public function edit($nik) {
		$data['title'] = "Edit penduduk - NAGARI KOTO NAN DUO";
	...
	public function detail($nik) {
		...
		$data['title'] = "Detail penduduk - NAGARI KOTO NAN DUO";
		$this->load->model('m_penduduk');
