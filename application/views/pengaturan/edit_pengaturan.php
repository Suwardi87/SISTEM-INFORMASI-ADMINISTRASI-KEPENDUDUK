      ...
      <form action="<?php echo base_url('pengaturan/proses_edit'); ?>" method="post">
        ...
        <div class="form-group">
		  ...
		  <select name="jabatan" class="form-control">
			<option value="Kepala Desa" <?php if($pengaturan->jabatan_pejabat == "Kepala Desa"){ echo "selected"; } ?>>walinagri</option>
			<option value="Sekertaris Desa" <?php if($pengaturan->jabatan_pejabat == "Sekertaris Desa"){ echo "selected"; } ?>>Sekertaris </option>
