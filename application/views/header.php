...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo base_url('assets/images/logo_barat.png'); ?>">
    ...
    <div class="wrapper">
        <header class="main-header">
            <a href="<?php echo base_url('beranda'); ?>" class="logo">
                ...
                <span class="logo-lg"><img src="<?php echo base_url('assets/images/logo_barat.png'); ?>" width="27"
                        alt="SIMPENDUK"><b>SIAK</b></span>
            </a>
                    ...
                    <ul class="nav navbar-nav">
                        <li>
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                Selamat datang <?php echo $this->session->userdata(''); ?>
                            </a>
