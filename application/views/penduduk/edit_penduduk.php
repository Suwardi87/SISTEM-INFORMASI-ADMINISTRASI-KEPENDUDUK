                ...
                <form action="<?php echo base_url('penduduk/proses_edit'); ?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control selectlive" name="Jorong" required>
                            <option value="<?php echo $penduduk->jorong; ?>" selected><?php echo $penduduk->jorong; ?></option>
                            <option value="Jorong Simpang">Jorong Simpang</option>
                            <option value="Jorong Air Runding">Jorong Air Runding</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label>Agama</label>
