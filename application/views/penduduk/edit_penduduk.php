		...
		<div class="box box-info">
			...
			<div class="box-body">
				...
				<form action="<?php echo base_url('penduduk/proses_edit'); ?>" method="post">
					...
					<div class="form-group">
						<label>Jorong</label>
						<select class="form-control selectlive" name="jorong" required>
							<option value="Jorong Simpang" <?php if ($penduduk->jorong == "Jorong Simpang") echo "selected"; ?>>Jorong Simpang</option>
							<option value="Jorong Air Runding" <?php if ($penduduk->jorong == "Jorong Air Runding") echo "selected"; ?>>Jorong Air Runding</option>
						</select>
					</div>
