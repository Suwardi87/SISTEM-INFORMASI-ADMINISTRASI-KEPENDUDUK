...
<img src="<?php echo base_url('assets/images/kop.png'); ?>" width="100%" height="30%">
<br /><br /><br />
<center>
...
<br /><br /><br />
<font align="justify">
    Yang bertanda tangan dibawah ini , <?php echo $usaha->jabatan_pejabat; ?> NAGARI KOTO NAN DUO
</font>
<table width="100%">
    <tr>
...
<br>
<font align="justify">
    Menurut penelitian dan Pengantar dari jorong setempat Nama/Orang tersebut benar Warga NAGARI KOTO NAN DUO , bahwa yang bersangkutan benar Membuka / Mempunyai Usaha
...
<table width="100%">
    <tr>
        <td width="50%"></td>
        <td width="50%">
            <center>NAGARI KOTO NAND DUO, <?= date('d F Y', strtotime($usaha->tanggal_usaha)); ?></center>
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td>
            <center>WALI NAGARI KOTO NAND DUO</center>
        </td>
    </tr>
    <tr>
        <td></td>
