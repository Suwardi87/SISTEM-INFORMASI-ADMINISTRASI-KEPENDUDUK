...
<br /><br /><br />
<font align="justify">
    Yang bertandatangan di bawah ini , <?php echo $surat_kelahiran->jabatan_pejabat; ?> NAGARI KOTO NAN DUO, menerangkan bahwa pada:
</font>
<table width="100%">
    <tr>
        <td width="20%">Hari</td>
...
<table width="100%">
    <tr>
        <td width="50%"></td>
        <td width="50%">
            <center>KOTO NAN DUO, <?= date('d F Y', strtotime($surat_kelahiran->tanggal_surat_kelahiran)); ?> </center>
        </td>
    </tr>
    <tr>
        <td></td>
        <td>
            <center>WALI NAGARI KOTO NAN DUO</center>
        </td>
    </tr>
    <tr>
        <td></td>
