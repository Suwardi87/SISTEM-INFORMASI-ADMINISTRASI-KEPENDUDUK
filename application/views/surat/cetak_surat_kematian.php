...
<table width="100%">
    <tr>
        <td width="15%">NAGARI/JORONG</td>
        <td width="1%">:</td>
        <td width="84%">NAGARI KOTO NAN DUO</td>
    </tr>
    <tr>
        <td>Kabupaten</td>
        <td>:</td>
...
<br /><br /><br />
<font align="justify">
    Yang bertandatangan di bawah ini , <?php echo $surat_kematian->jabatan_pejabat; ?> NAGARI KOTO NAN DUO, menerangkan bahwa pada:
</font>
<table width="100%">
    <tr>
        <td width="20%">Nama</td>
...
<table width="100%">
    <tr>
        <td width="50%"></td>
        <td width="50%">
            <center>koto nan duo, <?= date('d F Y', strtotime($surat_kematian->tanggal_surat_kematian)); ?></center>
        </td>
    </tr>
    <tr>
        <td></td>
        <td>
            <center>WALINAGARI KOTO NAN DUO</center>
        </td>
    </tr>
    <tr>
        <td></td>
