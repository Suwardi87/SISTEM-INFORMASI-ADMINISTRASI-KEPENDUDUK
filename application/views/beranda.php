    ...
    <section class="content">
        <div class="box box-info">
            <div class="box-header">
                <h4 style="text-align:center"><b>SELAMAT DATANG DI SISTEM INFORMASI ADMINISTRASI KEPENDUDUK<br>KANTOR
                        NAGARI KOTO NAN DUO</b></h4>
                <hr>
            </div>
            <div style="text-align: center;"> <img style="cent"
                    src="<?php echo base_url('assets/images/logo_barat.png'); ?>" width="200"
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div style="text-align: left;" class="col-sm-5 col-sm-offset-1">
                            <p> Nagari koto nan duo berkarya serta membangun untuk menciptakan masyarakat yang mandiri
                                dan harmonis</p>
                        </div>
